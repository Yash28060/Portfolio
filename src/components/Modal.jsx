                                ...
                                <div className="p-6 space-y-6">
                                    ...
                                    <ul className="list-disc ml-6 text-base leading-relaxed text-gray-500 dark:text-gray-400">
                                        {project.description.points.map((points) => {
                                            return (
                                                <li key={Math.random()}>
                                                    <strong>{points.title}</strong>:{points.desc}</li>
                                            )
                                        })}
                                    </ul>
                                </div>
                                <div className="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                                    <a href={project.link.deploy} data-modal-hide="staticModal" type="button" target="_blank" className="text-white pl-3 flex bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                        ...
                                        Demo</a>
                                    <a href={project.link.github} data-modal-hide="staticModal" type="button" target="_blank" className="text-gray-500 pl-4 flex bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
